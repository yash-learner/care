...
class ValueSet(BaseModel):
    ...
    resourceType: Literal["ValueSet"] = Field(
        ..., const=True, description="This is a ValueSet resource"
    )
    id: Id | None = Field(
        None,
    ...
    versionAlgorithmString: constr(regex="^^[\\s\\S]+$$") | None = Field(
        None,
    ...
    description: Markdown | None = Field(
        None,
...
ValueSetInclude.update_forward_refs()
